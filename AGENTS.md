...
PR #6 integrated the FDM-913-qualified CLI/runtime candidate at `4df6f3204c70a5daa58d0664dbac1b6cbce0f667` into `main` via merge commit `c57f5dbc2f4f82c66f5c01c7e6f69fc30564066f`. Do not try to reopen or reuse merged PR #6 as an active review. FDM-868 continues the existing `feat/cli-first-configuration` lineage for documentation/metadata-only release preparation in a new Draft PR. Runtime changes after FDM-913 require focused local requalification of affected scenarios. Keep the release-preparation candidate unmerged/unpublished until FDM-869 passes its exact SHA; FDM-874 owns publication. Never reopen abandoned UI PR #5.
